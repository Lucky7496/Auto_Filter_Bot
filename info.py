...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002508941580')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesearchgroup28')  # Support group link (make sure bot is admin)
